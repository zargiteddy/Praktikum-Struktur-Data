...
//------------------------------------------------------
public static void mengurutkanDataInsertionDescending(formatBiodata biodataMahasiswa[])
{
...
System.out.println("\n==Data sesudah diurutkan Insertion Descending ==");
mengurutkanDataInsertionDescending(biodataMahasiswa);
tampilkanData(biodataMahasiswa);
}
}